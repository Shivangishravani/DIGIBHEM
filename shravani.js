...
let price=document.getElementById("price");
     ...
     frequentitems.forEach(frequent => {
      frequent.addEventListener('click', function handleClick() {
        ...
        if(frequent.src=="https://rukminim2.flixcart.com/image/612/612/kvzkosw0hlty2aw/gas-stove/o/8/b/8906022173659-butterfly-original-imag8srpsz4fkgyz.jpeg?q=70")
        {
          producttitle.innerHTML="Pigeon Aster Gas Stove 3 Burner with High Powered Brass Burner, Gas Cooktop with Glass Top and Powder Coated Body, black, standard (14266)";
        ...
        else if(frequent.src=="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcTIRV_kZxjxxIYd1pNKcYRxmucljp-vfkHTMci-M01L29Azmekb-0MIC27Cgo3x63nDTLWZ8RROPB_9_6DrROUzw5IEKRTYNW-EY5juTLJC2aGDLqSQ0y2y&usqp=CAE")
        {
          producttitle.innerHTML="2 Ton Split Air Conditioner For Home Use With Low Power Consumption";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=38999;
            price.innerHTML=32499;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/1/7/l/-original-imaghgcj2z5cfugg.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="realme 10 (Clash White, 64 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=15999;
            price.innerHTML=12499;
        }
        else if(frequent.src=="https://www.havells.com/HavellsProductImages/HavellsIndia/Content/Consumer/Fans/ceiling-fans/decorative/FHCFESTMIST48/cover.PNG")
        {
          producttitle.innerHTML="Usha Bloom Daffodil Goodbye Dust Ceiling Fan 1250mm, Silver Coated";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=3775;
            price.innerHTML=2999;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/71+ZgKdJXTL._SX522_.jpg")
        {
          producttitle.innerHTML="Solimo Alpha 3 Door Engineered Wood Wardrobe with Drawer";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=19999;
            price.innerHTML=17999;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/41EcYoIZhIL._SY355_.jpg")
        {
          producttitle.innerHTML="Mettallic Mixer Grinder, 550W, 3 Jars (Black Orange)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=3999;
            price.innerHTML=3299;
        }
        else if(frequent.src=="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcSNIJSXo2PAwhmlixpP47YyRrQ0aDP3AwL3iHXQjit4kgO7jx5CJKvvwRHSfOXIxPN_qijM9UePqfJuMq0SSCzP0qlfv8RUDGs9PWaUOMuOBVv6n-44ECwK&usqp=CAE")
        {
          producttitle.innerHTML="Morphy Richards AT402 4 Slice Pop-up Toaster with Hi-lift Function, Variable Browning Control, Cool Touch Body, Removable Crumb Tray";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=2999;
            price.innerHTML=2500;
        }
        else if(frequent.src=="https://images-na.ssl-images-amazon.com/images/I/71QqpqHBDrL._AC_UL600_SR600,600_.jpg")
        {
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/61bXZFeHKOL._SX522_.jpg")
        {
          producttitle.innerHTML="Spotzero By Milton Wave Spin Mop, Aqua Green, Pack of 1, Plastic";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=1999;
            price.innerHTML=1499;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/61zQnN0orUL._AC_UF894,1000_QL80_.jpg")
        {
          producttitle.innerHTML="Polyresine Little Monk Laughing Buddha Set of 4 Suitable for Home Décor, Gifting, Car Dashboard";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=3999;
            price.innerHTML=2500;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/7134jQpGqVL._SY679_.jpg")
        {
          producttitle.innerHTML="GKT Female Dress Mannequin Form Natural Wheel Base Mannequin Premium Store Display Dummy Mannequin Dummy Model";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=7999;
            price.innerHTML=6489;
        }
        else if(frequent.src=="https://cpimg.tistatic.com/05736990/b/4/Wall-Mount-Long-Body-Water-Tap.jpg")
        {
          producttitle.innerHTML="nal Tap Faucet  (Built-in Installation Type)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=1200;
            price.innerHTML=1500;
        }
        else if(frequent.src=="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcRNgqGSvxohI7zWhWVqYDx1ZpN8PlvAEj9b2BqPOZi7rPg1pEdtsDQaT4U6DwjrlaW9fnyk5MDqIR76PD2RWgqDxlPWgeHLSOrusI4ogAG8NwzgxYj511c7&usqp=CAE")
        {
          producttitle.innerHTML="beatXP Stream Pro Cordless Full Body Massager Machine for Pain Relief with 4 Attachments - Electric Back Massager for Pain Relief with 4000mAh battery";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=2999;
            price.innerHTML=1499;
        }
        else if(frequent.src=="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcRRR6EOFnX6skihcdbT_5Ud3uEl3GafEZ5ZWN6ydnNSWQ6mUVC9yJhraK5Gd7Jf00vyXR886-9eHHcDNULyWQ5nw-fejp-vb7SglWgp9I9hLfYOMKJbcoMt&usqp=CAE")
        {
          producttitle.innerHTML="West Nation®️ 2 IN 1 Long handle bathroom tiles cleaning brush and wiper | Power scrub wipe washroom floor toilet wall wash basin window glass carpet with stiff bristle soft scraper";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=599;
            price.innerHTML=499;
        }
        //<i class="bi bi-star-fill"></i>
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/kklhbbk0/mobile/r/9/l/x7-pro-rmx2121-realme-original-imafzwfy6qqju8sm.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="realme X7 Pro 5G (Mystic Black, 128 GB)  (8 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=32999;
            price.innerHTML=29999;
            let img=document.getElementById("placeimage");
            console.log(img);
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/z/x/x/-original-imagp55frhhddu6n.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="realme C55 (Sunshower, 64 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=12999;
            price.innerHTML=10999;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/i/y/j/-original-imagkp8fpw35uygd.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="realme 10 Pro+ 5G (Nebula Blue, 128 GB)  (6 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=25999;
            price.innerHTML=22999;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/l0fm07k0/mobile/8/w/z/-original-imagc7ukpz8y4gpb.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="realme C35 (Glowing Black, 128 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-half">';
            mrp.innerHTML=14999;
            price.innerHTML=10699;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/w/w/o/-original-imagkp8yhmnua3cf.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="realme 10 Pro 5G (Nebula Blue, 128 GB)  (6 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-half">';
            mrp.innerHTML=20999;
            price.innerHTML=18699;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/y/9/g/-original-imagnfzyhh8gz8sd.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="POCO C55 (Cool Blue, 64 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=11999;
            price.innerHTML=7499;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/3/a/x/f5-5g-mzb0e7kin-poco-original-imagpep3dcnkbxp4.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="POCO F5 5G (Snowstorm White, 256 GB)  (8 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=34999;
            price.innerHTML=27499;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/y/z/1/g13-pawv0027in-motorola-original-imagz4rbyyggfhdz.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="MOTOROLA g13 (Matte Charcoal, 128 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=13999;
            price.innerHTML=9999;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/c/s/x/-original-imagzjhwaaewgj8r.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="vivo T2x 5G (Aurora Gold, 128 GB)  (6 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=18999;
            price.innerHTML=13999;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/x/x/s/-original-imagfhu6dcpdnqkh.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="SAMSUNG Galaxy F13 (Sunrise Copper, 64 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=14999;
            price.innerHTML=10999;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/0/8/4/-original-imagfhu75eupxyft.jpeg?q=70")
        {
          
          alert("scroll down");
          producttitle.innerHTML="SAMSUNG Galaxy F13 (Waterfall Blue, 128 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=16999;
            price.innerHTML=11999;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/w/d/o/-original-imaghgbyhy6banxv.jpeg?q=70")
        {
          alert("scroll down");
          producttitle.innerHTML="SAMSUNG Galaxy F04 (Opal Green, 64 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=11499;
            price.innerHTML=8499;
        }
        else if(frequent.src=="https://rukminim2.flixcart.com/image/416/416/xif0q/mobile/0/8/4/-original-imagfhu75eupxyft.jpeg?q=70")
        {
          alert("scrolldown");
          producttitle.innerHTML="SAMSUNG Galaxy F13 (Waterfall Blue, 64 GB)  (4 GB RAM)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=8999;
            price.innerHTML=11499;
        }
        ////
